    ...
    <div className={styles.container}>
      <Row justify='space-between' className={styles.menu_row}>
        <div className={styles.menu_contents}>
          <Row>
            <a href='#'><Text color='white' className={styles.menu_text}>ドキュメント</Text></a>
            <div className={styles.padding_left_16px}></div>
            <a href='#'> <Text color='white' className={styles.menu_text}>ライブラリ</Text></a>
            <div className={styles.padding_left_16px}></div>
            <a href='#'><Text color='white' className={styles.menu_text}>私たちについて</Text></a>
